...
var _23b=this._getPlaces();
if(_23b!==""){
p.editOptions.places=_23b;
...
},_createEditor:function(_23c,_23d){
var e;
if(this.spinnerButtons&&!wm.isMobile){
e=new dijit.form.NumberSpinner(this.getEditorProps(_23c,_23d));
}else{
e=new dijit.form.NumberTextBox(this.getEditorProps(_23c,_23d));
}
return e;
},setMaximum:function(_23e){
var v=(_23e==="")?"":Number(_23e);
...
var _240={};
if(this.places&&this.places!=""){
_240.places=parseInt(this.places);
}
return _240;
},setSpinnerButtons:function(_241){
if(this.spinnerButtons!=_241){
this.spinnerButtons=_241;
this.createEditor();
}
},calcIsDirty:function(a,b){
return a!==b;
}});
dojo.declare("wm.Currency",wm.Number,{currency:"",getEditorProps:function(_242,_243){
var prop=this.inherited(arguments);
if(prop.constraints){
delete prop.constraints.pattern;
}
return dojo.mixin(prop,{currency:this.currency||(this._isDesignLoaded?studio.application.currencyLocale:app.currencyLocale)||"USD"},_243||{});
},_createEditor:function(_244,_245){
return new dijit.form.CurrencyTextBox(this.getEditorProps(_244,_245));
},_getReadonlyValue:function(){
...
var _24b=this;
dojo.mixin(_24b,args);
_24b.node=args.node;
_24b._showArgs=dojo.mixin({},args);
_24b._showArgs.node=_24b.node;
_24b._showArgs.duration=_24b.showDuration;
_24b.showAnim=_24b.showFunc(_24b._showArgs);
_24b._hideArgs=dojo.mixin({},args);
_24b._hideArgs.node=_24b.node;
_24b._hideArgs.duration=_24b.hideDuration;
_24b.hideAnim=_24b.hideFunc(_24b._hideArgs);
dojo.connect(_24b.showAnim,"beforeBegin",dojo.hitch(_24b.hideAnim,"stop",true));
dojo.connect(_24b.hideAnim,"beforeBegin",dojo.hitch(_24b.showAnim,"stop",true));
},show:function(_24c){
return this.showAnim.play(_24c||0);
},hide:function(_24d){
return this.hideAnim.play(_24d||0);
}});
}
...
(function(){
var d=dojo,_24e={_fire:function(evt,args){
if(this[evt]){
...
d.extend(_24f,{_onAnimate:function(){
...
if(!_252&&this._current.status()=="playing"){
return this;
}
var _253=d.connect(this._current,"beforeBegin",this,function(){
this._fire("beforeBegin");
}),_254=d.connect(this._current,"onBegin",this,function(arg){
this._fire("onBegin",arguments);
}),_255=d.connect(this._current,"onPlay",this,function(arg){
...
return this;
},gotoPercent:function(_256,_257){
this.pause();
var _258=this.duration*_256;
this._current=null;
...
if(this._current){
this._current.gotoPercent(_258/this._current.duration,_257);
}
return this;
},stop:function(_259){
if(this._current){
...
d.extend(_24f,_24e);
dojo.fx.chain=function(_25a){
return new _24f(_25a);
};
var _25b=function(_25c){
this._animations=_25c||[];
this._connects=[];
this._finished=0;
this.duration=0;
d.forEach(_25c,function(a){
var _25d=a.duration;
if(a.delay){
_25d+=a.delay;
}
if(this.duration<_25d){
this.duration=_25d;
}
...
d.extend(_25b,{_doAction:function(_25e,args){
d.forEach(this._animations,function(a){
a[_25e].apply(a,args);
});
return this;
...
},_call:function(_25f,args){
var t=this._pseudoAnimation;
t[_25f].apply(t,args);
},play:function(_260,_261){
this._finished=0;
...
var ms=this.duration*_262;
d.forEach(this._animations,function(a){
a.gotoPercent(a.duration<ms?1:(ms/a.duration),_263);
});
...
d.extend(_25b,_24e);
dojo.fx.combine=function(_265){
return new _25b(_265);
};
...
var _266=d.style(node,"height");
return Math.max(_266,1);
}
},end:function(){
...
var top,_268,left,_269,_26a,_26b=null;
var init=(function(n){
return function(){
...
_26a=(w=="auto"?0:parseInt(w));
_26b=(h=="auto"?0:parseInt(h));
_269=left-Math.floor((args.width-_26a)/2);
_268=top-Math.floor((args.height-_26b)/2);
...
var _26c=dojo.animateProperty(dojo.mixin({properties:{height:function(){
init();
return {end:args.height||0,start:_26b};
},top:function(){
return {start:top,end:_268};
}}},args));
var _26d=dojo.animateProperty(dojo.mixin({properties:{width:function(){
return {start:_26a,end:args.width||0};
},left:function(){
return {start:left,end:_269};
}}},args));
var anim=dojo.fx[(args.method=="combine"?"combine":"chain")]([_26c,_26d]);
return anim;
};
...
init();
var _26e=dojo.animateProperty(dojo.mixin({properties:{top:top+(args.top||0),left:left+(args.left||0)}},args));
dojo.connect(_26e,"beforeBegin",_26e,init);
return _26e;
};
dojox.fx.crossFade=function(args){
var _26f=args.nodes[0]=dojo.byId(args.nodes[0]),op1=dojo.style(_26f,"opacity"),_270=args.nodes[1]=dojo.byId(args.nodes[1]),op2=dojo.style(_270,"opacity");
var _271=dojo.fx.combine([dojo[(op1==0?"fadeIn":"fadeOut")](dojo.mixin({node:_26f},args)),dojo[(op1==0?"fadeOut":"fadeIn")](dojo.mixin({node:_270},args))]);
return _271;
};
dojox.fx.highlight=function(args){
var node=args.node=dojo.byId(args.node);
args.duration=args.duration||400;
var _272=args.color||"#ffff99",_273=dojo.style(node,"backgroundColor");
if(_273=="rgba(0, 0, 0, 0)"){
_273="transparent";
}
var anim=dojo.animateProperty(dojo.mixin({properties:{backgroundColor:{start:_272,end:_273}}},args));
if(_273=="transparent"){
dojo.connect(anim,"onEnd",anim,function(){
node.style.backgroundColor=_273;
});
}
return anim;
};
...
var dir=(args.width?"width":"height"),_274=args[dir],_275={};
_275[dir]={start:function(){
s.overflow="hidden";
if(s.visibility=="hidden"||s.display=="none"){
s[dir]="1px";
s.display="";
...
var anim=dojo.animateProperty(dojo.mixin({properties:_275},args));
return anim;
};
}
...
this.inherited(arguments);
this.value.sort(this._isReversed()?_276:_277);
var _278=this;
var _279=dojo.declare(dijit.form._SliderMoverMax,{constructor:function(){
this.widget=_278;
}});
this._movableMax=new dojo.dnd.Moveable(this.sliderHandleMax,{mover:_279});
dijit.setWaiState(this.focusNodeMax,"valuemin",this.minimum);
dijit.setWaiState(this.focusNodeMax,"valuemax",this.maximum);
var _27a=dojo.declare(dijit.form._SliderBarMover,{constructor:function(){
this.widget=_278;
}});
this._movableBar=new dojo.dnd.Moveable(this.progressBar,{mover:_27a});
},destroy:function(){
this.inherited(arguments);
...
var _27b=e.currentTarget,_27c=false,_27d=false,k=dojo.keys;
if(_27b==this.sliderHandle){
_27c=true;
}else{
if(_27b==this.progressBar){
_27d=_27c=true;
}else{
if(_27b==this.sliderHandleMax){
_27d=true;
}
}
}
switch(e.keyCode){
case k.HOME:
this._setValueAttr(this.minimum,true,_27d);
break;
case k.END:
this._setValueAttr(this.maximum,true,_27d);
break;
...
},_bumpValue:function(_27e,_27f){
var _280=dojo.isArray(_27e)?[this._getBumpValue(_27e[0].change,_27e[0].useMaxValue),this._getBumpValue(_27e[1].change,_27e[1].useMaxValue)]:this._getBumpValue(_27e,_27f);
this._setValueAttr(_280,true,!dojo.isArray(_27e)&&((_27e>0&&!_27f)||(_27f&&_27e<0)));
},_getBumpValue:function(_281,_282){
var s=dojo.getComputedStyle(this.sliderBarContainer),c=dojo._getContentBox(this.sliderBarContainer,s),_283=this.discreteValues,_284=!_282?this.value[0]:this.value[1];
if(_283<=1||_283==Infinity){
_283=c[this._pixelCount];
}
_283--;
if((this._isReversed()&&_281<0)||(_281>0&&!this._isReversed())){
_284=!_282?this.value[1]:this.value[0];
}
var _285=(_284-this.minimum)*_283/(this.maximum-this.minimum)+_281;
if(_285<0){
_285=0;
}
if(_285>_283){
...
return _285*(this.maximum-this.minimum)/_283+this.minimum;
},_onBarClick:function(e){
if(this.disabled||this.readOnly){
return;
}
...
var _286=dojo.coords(this.sliderBarContainer,true),bar=dojo.coords(this.progressBar,true),_287=e[this._mousePixelCoord]-_286[this._startingPixelCoord],_288=bar[this._startingPixelCount],_289=_288+bar[this._pixelCount],_28a=this._isReversed()?_287<=_288:_287>=_289,p=this._isReversed()?_286[this._pixelCount]-_287:_287;
this._setPixelValue(p,_286[this._pixelCount],true,_28a);
dojo.stopEvent(e);
},_setPixelValue:function(_28b,_28c,_28d,_28e){
if(this.dynamicSlider){
_28d=true;
}
if(this.disabled||this.readOnly){
...
var _28f=this._getValueByPixelValue(_28b,_28c);
this._setValueAttr(_28f,_28d,_28e);
},_getValueByPixelValue:function(_290,_291){
_290=_290<0?0:_291<_290?_291:_290;
var _292=this.discreteValues;
if(_292<=1||_292==Infinity){
_292=_291;
}
_292--;
var _293=_291/_292;
var _294=Math.round(_290/_293);
return (this.maximum-this.minimum)*_294/_292+this.minimum;
},_setValueAttr:function(_295,_296,_297){
var _298=this.value;
if(!dojo.isArray(_298)){
_298=[0,0];
}
...
this.valueNode.value=this.value=_295=_298;
dijit.setWaiState(this.focusNode,"valuenow",_298[0]);
dijit.setWaiState(this.focusNodeMax,"valuenow",_298[1]);
this.value.sort(this._isReversed()?_276:_277);
dijit.form._FormValueWidget.prototype._setValueAttr.apply(this,arguments);
this._printSliderBar(_296,_297);
},_printSliderBar:function(_299,_29a){
var _29b=(this.value[0]-this.minimum)/(this.maximum-this.minimum);
var _29c=(this.value[1]-this.minimum)/(this.maximum-this.minimum);
var _29d=_29b;
if(_29b>_29c){
_29b=_29c;
_29c=_29d;
}
var _29e=this._isReversed()?((1-_29b)*100):(_29b*100);
var _29f=this._isReversed()?((1-_29c)*100):(_29c*100);
var _2a0=this._isReversed()?((1-_29c)*100):(_29b*100);
if(_299&&this.slideDuration>0&&this.progressBar.style[this._progressPixelSize]){
var _2a1=_29a?_29c:_29b;
var _2a2=this;
var _2a3={};
var _2a4=parseFloat(this.progressBar.style[this._handleOffsetCoord]);
var _2a5=this.slideDuration/10;
if(_2a5===0){
return;
}
if(_2a5<0){
...
var _2a7={};
var _2a8={};
_2a6[this._handleOffsetCoord]={start:this.sliderHandle.style[this._handleOffsetCoord],end:_29e,units:"%"};
_2a7[this._handleOffsetCoord]={start:this.sliderHandleMax.style[this._handleOffsetCoord],end:_29f,units:"%"};
_2a8[this._handleOffsetCoord]={start:this.progressBar.style[this._handleOffsetCoord],end:_2a0,units:"%"};
_2a8[this._progressPixelSize]={start:this.progressBar.style[this._progressPixelSize],end:(_29c-_29b)*100,units:"%"};
var _2a9=dojo.animateProperty({node:this.sliderHandle,duration:_2a5,properties:_2a6});
var _2aa=dojo.animateProperty({node:this.sliderHandleMax,duration:_2a5,properties:_2a7});
var _2ab=dojo.animateProperty({node:this.progressBar,duration:_2a5,properties:_2a8});
var _2ac=dojo.fx.combine([_2a9,_2aa,_2ab]);
_2ac.play();
}else{
this.sliderHandle.style[this._handleOffsetCoord]=_29e+"%";
this.sliderHandleMax.style[this._handleOffsetCoord]=_29f+"%";
this.progressBar.style[this._handleOffsetCoord]=_2a0+"%";
this.progressBar.style[this._progressPixelSize]=((_29c-_29b)*100)+"%";
}
}});
dojo.declare("dijit.form._SliderMoverMax",dijit.form._SliderMover,{onMouseMove:function(e){
var _2ad=this.widget;
var _2ae=_2ad._abspos;
if(!_2ae){
_2ae=_2ad._abspos=dojo.coords(_2ad.sliderBarContainer,true);
_2ad._setPixelValue_=dojo.hitch(_2ad,"_setPixelValue");
_2ad._isReversed_=_2ad._isReversed();
}
var _2af=e.touches?e.touches[0]:e;
var _2b0=_2af[_2ad._mousePixelCoord]-_2ae[_2ad._startingPixelCoord];
_2ad._setPixelValue_(_2ad._isReversed_?(_2ae[_2ad._pixelCount]-_2b0):_2b0,_2ae[_2ad._pixelCount],false,true);
},destroy:function(e){
dojo.dnd.Mover.prototype.destroy.apply(this,arguments);
var _2b1=this.widget;
_2b1._abspos=null;
_2b1._setValueAttr(_2b1.value,true);
}});
dojo.declare("dijit.form._SliderBarMover",dojo.dnd.Mover,{onMouseMove:function(e){
var _2b2=this.widget;
if(_2b2.disabled||_2b2.readOnly){
return;
}
var _2b3=_2b2._abspos;
var bar=_2b2._bar;
var _2b4=_2b2._mouseOffset;
if(!_2b3){
_2b3=_2b2._abspos=dojo.coords(_2b2.sliderBarContainer,true);
_2b2._setPixelValue_=dojo.hitch(_2b2,"_setPixelValue");
_2b2._getValueByPixelValue_=dojo.hitch(_2b2,"_getValueByPixelValue");
_2b2._isReversed_=_2b2._isReversed();
}
if(!bar){
bar=_2b2._bar=dojo.coords(_2b2.progressBar,true);
}
var _2b5=e.touches?e.touches[0]:e;
if(!_2b4){
_2b4=_2b2._mouseOffset=_2b5[_2b2._mousePixelCoord]-_2b3[_2b2._startingPixelCoord]-bar[_2b2._startingPixelCount];
}
var _2b6=_2b5[_2b2._mousePixelCoord]-_2b3[_2b2._startingPixelCoord]-_2b4,_2b7=_2b6+bar[_2b2._pixelCount];
pixelValues=[_2b6,_2b7];
pixelValues.sort(_277);
if(pixelValues[0]<=0){
pixelValues[0]=0;
pixelValues[1]=bar[_2b2._pixelCount];
}
if(pixelValues[1]>=_2b3[_2b2._pixelCount]){
pixelValues[1]=_2b3[_2b2._pixelCount];
pixelValues[0]=_2b3[_2b2._pixelCount]-bar[_2b2._pixelCount];
}
var _2b8=[_2b2._getValueByPixelValue(_2b2._isReversed_?(_2b3[_2b2._pixelCount]-pixelValues[0]):pixelValues[0],_2b3[_2b2._pixelCount]),_2b2._getValueByPixelValue(_2b2._isReversed_?(_2b3[_2b2._pixelCount]-pixelValues[1]):pixelValues[1],_2b3[_2b2._pixelCount])];
_2b2._setValueAttr(_2b8,false,false);
},destroy:function(){
dojo.dnd.Mover.prototype.destroy.apply(this,arguments);
var _2b9=this.widget;
_2b9._abspos=null;
_2b9._bar=null;
_2b9._mouseOffset=null;
_2b9._setValueAttr(_2b9.value,true);
}});
...
},setVerticalSlider:function(_2ba){
this.verticalSlider=_2ba;
if(this.editor){
this.createEditor();
}
if(this.verticalSlider){
...
},getEditorProps:function(_2bb,_2bc){
var v=this.dataValue;
var minV=Number(this.minimum)?Number(this.minimum):0;
if(!v||(Number(v)<minV)){
v=this.displayValue=minV;
}
return dojo.mixin(this.inherited(arguments),{dynamicSlider:this.dynamicSlider,minimum:Number(this.minimum),maximum:Number(this.maximum),showButtons:Boolean(this.showButtons),discreteValues:Number(this.discreteValues)||Infinity,value:v},_2bc||{});
},setMaximum:function(_2bd){
this.maximum=(_2bd==="")?100:Number(_2bd);
if(this.editor){
this.editor.maximum=this.maximum;
this.editor._setValueAttr(this.dataValue,true);
}
},setMinimum:function(_2be){
this.minimum=(_2be==="")?0:Number(_2be);
if(this.editor){
this.editor.minimum=this.minimum;
this.editor._setValueAttr(this.dataValue,true);
}
},_createEditor:function(_2bf,_2c0){
var div=dojo.create("div");
var _2c1;
if(this.verticalSlider){
_2c1=new dijit.form.VerticalSlider(this.getEditorProps(_2bf,_2c0));
}else{
_2c1=new dijit.form.HorizontalSlider(this.getEditorProps(_2bf,_2c0));
}
div.appendChild(_2c1.domNode);
_2c1.domNode=div;
return _2c1;
},sizeEditor:function(){
if(this._cupdating){
...
var _2c2=this.inherited(arguments);
if(this.integerValues){
return Math.round(_2c2);
}else{
return _2c2;
}
},editorChanged:function(){
...
},_createEditor:function(_2c4,_2c5){
var div=dojo.create("div");
var _2c6=new dojox.form.HorizontalRangeSlider(this.getEditorProps(_2c4,_2c5));
div.appendChild(_2c6.domNode);
_2c6.domNode=div;
return _2c6;
},getEditorValue:function(){
var _2c7=wm.AbstractEditor.prototype.getEditorValue.call(this);
if(this.integerValues){
_2c7[0]=Math.round(_2c7[0]);
_2c7[1]=Math.round(_2c7[1]);
}
return _2c7;
},getDisplayValue:function(){
var _2c8=this.getEditorValue();
return _2c8[0]+","+_2c8[1];
},getTopValue:function(){
return this.getEditorValue()[1];
},getBottomValue:function(){
return this.getEditorValue()[0];
},setDisplayValue:function(_2c9){
if(typeof _2c9=="string"){
_2c9=_2c9.split(/\s*,\s*/);
}
this.inherited(arguments,[_2c9]);
},setTopValue:function(_2ca){
this.setDataValue([this.getBottomValue(),_2ca]);
},setBottomValue:function(_2cb){
this.setDataValue([_2cb,this.getTopValue()]);
},calcIsDirty:function(_2cc,_2cd){
if(!_2cc&&_2cd||!_2cd&&_2cc){
return true;
}
return (_2cc[0]==_2cd[0]&&_2cc[1]==_2cd[1]);
},editorChanged:function(){
this.inherited(arguments);
var _2ce=this.getEditorValue();
this.valueChanged("bottomValue",_2ce[0]);
this.valueChanged("topValue",_2ce[1]);
}});
}
